      ...
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> ${member.membername }<span class="caret"></span></a>
				...
				<div class="col-md-12">
					<div class="thumbnail" style="    border-radius: 0px;">
						...
						<div class="caption" style="text-align:center;">
							...
							<#if member.authstatus == 1>
								<span class="label label-warning" style="cursor:pointer;">审核中</span>
							<#elseif member.authstatus == 2>
								<span class="label label-success" style="cursor:pointer;">已实名认证</span>
							<#else>
								<span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='/member/apply'">未实名认证</span>
							</#if>
						</div>
					</div>
				</div>
