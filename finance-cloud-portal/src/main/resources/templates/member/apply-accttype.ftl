...
.seltype {
 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <h2>商业公司</h2>
        <a href="#"  accttype="0" class="thumbnail">
	...
	<script>
	    ...
	    function doApply(){
	    	if(accttype == null){
	    		layer.msg("请选择", {time:1500, icon:5, shift:6});
	    	}else{
		    	$.ajax({
		    		type : "POST",
		    		data : {
		    		...
		    		url : "${APP_PATH}/member/updateAccountType",
		    		success: function(){
